...
# TinyGP size 10
set output '../plots/nikuradse_2_size10_run1_uniq' . extension
plot '< mlr --csv --fs '';'' --from ../results/nikuradse_2_size10/run1_simplified.csv.gz stats1 -g generation -a distinct_count -f individual_index,expression,parsedhash,simplifiedhash' using 1:2 with lines title 'individuals',\
     '' using 1:3 with lines title "distinct expr",\
     '' using 1:4 with lines title "distinct structures",\
     '' using 1:5 with lines title "distinct structures (simplified)",\
...
set output '../plots/rar_size10_run1_uniq' . extension
...
### Operon size 10
set output '../plots/nikuradse_2_size10_operon_run1_uniq' . extension
...
###### TinyGP size 12
set output '../plots/nikuradse_2_size12_run1_uniq' . extension
...
set output '../plots/rar_size12_run1_uniq' . extension
...
###### Operon size 12
set output '../plots/nikuradse_2_size12_operon_run1_uniq' . extension
...
set output '../plots/nikuradse_2_size20_run1_uniq' . extension
...
set output '../plots/rar_size20_run1_uniq' . extension
...
####### Operon size 20
set output '../plots/nikuradse_2_size20_operon_run1_uniq' . extension
...
######## Tiny GP size 10
set output '../plots/nikuradse_2_size10_run1_uniq_accumulated' . extension
plot '< mlr --csv --fs '';'' --from ../results/nikuradse_2_size10/run1_simplified.csv.gz stats1 -s -a distinct_count -f individual_index,expression,parsedhash,simplifiedhash then cut -f expression_distinct_count,parsedhash_distinct_count,simplifiedhash_distinct_count' using 0:1 with lines title 'distinct expr',\
     '' using 0:2 with lines title "distinct structures",\
     '' using 0:3 with lines title "distinct structures (simplified)",\
...
set output '../plots/rar_size10_run1_uniq_accumulated' . extension
plot '< mlr --csv --fs '';'' --from ../results/rar_size10/run1_simplified.csv.gz stats1 -s -a distinct_count -f individual_index,expression,parsedhash,simplifiedhash then cut -f expression_distinct_count,parsedhash_distinct_count,simplifiedhash_distinct_count' using 0:1 with lines title 'distinct expr',\
     '' using 0:2 with lines title "distinct structures",\
     '' using 0:3 with lines title "distinct structures (simplified)",\
...
########## Operon size 10
set output '../plots/nikuradse_2_size10_operon_run1_uniq_accumulated' . extension
plot '< mlr --csv --fs '';'' --from ../results/operon/nikuradse_2_size10/run1_simplified.csv.gz stats1 -s -a distinct_count -f evals,expr,parsedhash,simplifiedhash then cut -f expr_distinct_count,parsedhash_distinct_count,simplifiedhash_distinct_count' using 0:1 with lines title 'distinct expr',\
     '' using 0:2 with lines title "distinct structures",\
     '' using 0:3 with lines title "distinct structures (simplified)",\
...
########### TinyGP size 12     
set output '../plots/nikuradse_2_size12_run1_uniq_accumulated' . extension
plot '< mlr --csv --fs '';'' --from ../results/nikuradse_2_size12/run1_simplified.csv.gz stats1 -s -a distinct_count -f individual_index,expression,parsedhash,simplifiedhash then cut -f expression_distinct_count,parsedhash_distinct_count,simplifiedhash_distinct_count' using 0:1 with lines title 'distinct expr',\
     '' using 0:2 with lines title "distinct structures",\
     '' using 0:3 with lines title "distinct structures (simplified)",\
...
set output '../plots/rar_size12_run1_uniq_accumulated' . extension
plot '< mlr --csv --fs '';'' --from ../results/rar_size12/run1_simplified.csv.gz stats1 -s -a distinct_count -f individual_index,expression,parsedhash,simplifiedhash then cut -f expression_distinct_count,parsedhash_distinct_count,simplifiedhash_distinct_count' using 0:1 with lines title 'distinct expr',\
     '' using 0:2 with lines title "distinct structures",\
     '' using 0:3 with lines title "distinct structures (simplified)",\
...
set output '../plots/nikuradse_2_size12_operon_run1_uniq_accumulated' . extension
plot '< mlr --csv --fs '';'' --from ../results/operon/nikuradse_2_size12/run1_simplified.csv.gz stats1 -s -a distinct_count -f evals,expr,parsedhash,simplifiedhash then cut -f expr_distinct_count,parsedhash_distinct_count,simplifiedhash_distinct_count' using 0:1 with lines title 'distinct expr',\
     '' using 0:2 with lines title "distinct structures",\
     '' using 0:3 with lines title "distinct structures (simplified)",\
...
set output '../plots/nikuradse_2_size20_run1_uniq_accumulated' . extension
plot '< mlr --csv --fs '';'' --from ../results/nikuradse_2_size20/run1_simplified.csv.gz stats1 -s -a distinct_count -f individual_index,expression,parsedhash,simplifiedhash then cut -f expression_distinct_count,parsedhash_distinct_count,simplifiedhash_distinct_count' using 0:1 with lines title 'distinct expr',\
     '' using 0:2 with lines title "distinct structures",\
     '' using 0:3 with lines title "distinct structures (simplified)",\
...
set output '../plots/rar_size20_run1_uniq_accumulated' . extension
plot '< mlr --csv --fs '';'' --from ../results/rar_size20/run1_simplified.csv.gz stats1 -s -a distinct_count -f individual_index,expression,parsedhash,simplifiedhash then cut -f expression_distinct_count,parsedhash_distinct_count,simplifiedhash_distinct_count' using 0:1 with lines title 'distinct expr',\
     '' using 0:2 with lines title "distinct structures",\
     '' using 0:3 with lines title "distinct structures (simplified)",\
...
########### Operon size 20
set output '../plots/nikuradse_2_size20_operon_run1_uniq_accumulated' . extension
plot '< mlr --csv --fs '';'' --from ../results/operon/nikuradse_2_size20/run1_simplified.csv.gz stats1 -s -a distinct_count -f evals,expr,parsedhash,simplifiedhash then cut -f expr_distinct_count,parsedhash_distinct_count,simplifiedhash_distinct_count' using 0:1 with lines title 'distinct expr',\
     '' using 0:2 with lines title "distinct structures",\
     '' using 0:3 with lines title "distinct structures (simplified)",\
