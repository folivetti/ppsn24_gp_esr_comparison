...
plot '< cd ../results/rs/rar_size10 && bash prepare_ecdf.sh -995'   using 3:($1/50) with step lc 1        title "RS nll < -995",\
     '< cd ../results/rar_size10 && bash prepare_ecdf.sh 995'       using 3:($1/50) with step lc 1 dt "." title "GP nll < -995",\
     '< cd ../results/rs/rar_size10 && bash prepare_ecdf.sh -1000'  using 3:($1/50) with step lc 2        title "RS nll < -1000",\
     '< cd ../results/rar_size10 && bash prepare_ecdf.sh 1000'      using 3:($1/50) with step lc 2 dt "." title "GP nll < -1000",\
...
plot '< cd ../results/nikuradse_2_size10 && bash prepare_ecdf.sh -0.02'         using 2:($1/50) with step lc 1        title "GP MSE < 0.0200",\
     ...
     '< cd ../results/rs/nikuradse_2_size10 && bash prepare_ecdf.sh 0.02'       using 2:($1/50) with step lc 1 dt "-" title "RS MSE < 0.0200",\
     ...
     '< cd ../results/rs/nikuradse_2_size10 && bash prepare_ecdf.sh 0.01'       using 2:($1/50) with step lc 2 dt "-" title "RS MSE < 0.0100",\
