...
set output "../plots/with_operon/nikuradse2_ecdf" . extension
...
plot '< cd ../results/nikuradse_2_size10 && bash prepare_ecdf.sh -0.02'          using 2:($1/50) with step lc 1 lw 2        title "GP, 0.02",\
     ...
     '< cd ../results/operon/nikuradse_2_size10 && bash prepare_ecdf.sh -0.02'   using 2:($1/50) with step lc 1 lw 2 dt "." title "Operon, 0.02",\
     '< cd ../results/operon/nikuradse_2_size10 && bash prepare_ecdf.sh -0.01'   using 2:($1/50) with step lc 2 lw 2 dt "." title "Operon, 0.01",\
     '< cd ../results/operon/nikuradse_2_size10 && bash prepare_ecdf.sh -0.005'  using 2:($1/50) with step lc 3 lw 2 dt "." title "Operon, 0.0050",\
     '< cd ../results/operon/nikuradse_2_size10 && bash prepare_ecdf.sh -0.0027' using 2:($1/50) with step lc 4 lw 2 dt "." title "Operon, 0.0027"

set xrange[100:2000000]
set xtics 100,100,900000
# GP based on mse
set key rmargin Left maxcols 1 samplen 2 spacing 0.7 width -7
unset ylabel
unset ytics
...
plot '< cd ../results/nikuradse_2_size12 && bash prepare_ecdf.sh -0.02'          using 2:($1/50) with step lc 1 lw 2        title "GP, 0.02",\
     ...
     '< cd ../results/operon/nikuradse_2_size12 && bash prepare_ecdf.sh -0.02'   using 2:($1/50) with step lc 1 lw 2 dt "." title "Operon, 0.02",\
     '< cd ../results/operon/nikuradse_2_size12 && bash prepare_ecdf.sh -0.01'   using 2:($1/50) with step lc 2 lw 2 dt "." title "Operon, 0.01",\
     '< cd ../results/operon/nikuradse_2_size12 && bash prepare_ecdf.sh -0.005'  using 2:($1/50) with step lc 3 lw 2 dt "." title "Operon, 0.005",\
     '< cd ../results/operon/nikuradse_2_size12 && bash prepare_ecdf.sh -0.002'  using 2:($1/50) with step lc 4 lw 2 dt "." title "Operon, 0.002",\
     '< cd ../results/operon/nikuradse_2_size12 && bash prepare_ecdf.sh -0.0015' using 2:($1/50) with step lc 5 lw 2 dt "." title "Operon, 0.0015"
...
set output "../plots/with_operon/nikuradse2_ecdf_fevals" . extension
set multiplot layout 1,2 margins 0.1, 0.7, 0.2, 0.85 spacing 0.02,0
# GP based on mse
set title "Nikuradse len=10"
set ylabel "Success probability"
...
plot '< cd ../results/nikuradse_2_size10 && bash prepare_ecdf.sh -0.02'          using ($2*10):($1/50) with step lc 1 lw 2        title "GP, 0.02",\
     ...
     '< cd ../results/operon/nikuradse_2_size10 && bash prepare_ecdf.sh -0.02'   using ($2*10):($1/50) with step lc 1 lw 2 dt "." title "Operon, 0.020",\
     '< cd ../results/operon/nikuradse_2_size10 && bash prepare_ecdf.sh -0.01'   using ($2*10):($1/50) with step lc 2 lw 2 dt "." title "Operon, 0.010",\
     '< cd ../results/operon/nikuradse_2_size10 && bash prepare_ecdf.sh -0.005'  using ($2*10):($1/50) with step lc 3 lw 2 dt "." title "Operon, 0.005",\
     '< cd ../results/operon/nikuradse_2_size10 && bash prepare_ecdf.sh -0.0027' using ($2*10):($1/50) with step lc 4 lw 2 dt "." title "Operon, 0.0027"
...
plot '< cd ../results/nikuradse_2_size12 && bash prepare_ecdf.sh -0.02'          using ($2*10):($1/50) with step lc 1 lw 2        title "GP, 0.02",\
     ...
     '< cd ../results/operon/nikuradse_2_size12 && bash prepare_ecdf.sh -0.02'   using ($2*10):($1/50) with step lc 1 lw 2 dt "." title "Operon, 0.02",\
     '< cd ../results/operon/nikuradse_2_size12 && bash prepare_ecdf.sh -0.01'   using ($2*10):($1/50) with step lc 2 lw 2 dt "." title "Operon, 0.01",\
     '< cd ../results/operon/nikuradse_2_size12 && bash prepare_ecdf.sh -0.005'  using ($2*10):($1/50) with step lc 3 lw 2 dt "." title "Operon, 0.005",\
     '< cd ../results/operon/nikuradse_2_size12 && bash prepare_ecdf.sh -0.0027' using ($2*10):($1/50) with step lc 4 lw 2 dt "." title "Operon, 0.0027",\
     '< cd ../results/operon/nikuradse_2_size12 && bash prepare_ecdf.sh -0.002'  using ($2*10):($1/50) with step lc 5 lw 2 dt "." title "Operon, 0.002",\
     '< cd ../results/operon/nikuradse_2_size12 && bash prepare_ecdf.sh -0.0015' using ($2*10):($1/50) with step lc 6 lw 2 dt "." title "Operon, 0.0015"
...
set output "../plots/with_operon/nikuradse2_ecdf_restarts" . extension
set multiplot layout 1,2 margins 0.1, 0.7, 0.2, 0.85 spacing 0.02,0
# GP based on mse
set title "Nikuradse len=10"
set ylabel "Success probability"
...
# GP based on mse
set key rmargin Left maxcols 1 samplen 2 spacing 0.7
unset ylabel
unset ytics
set title "Nikuradse len=12"
plot '< cd ../results/nikuradse_2_size12 && bash prepare_ecdf.sh -0.02'          using 2:($1/50) with step lc 1 lw 2        title "GP, 0.02",\
     ...
     '< cd ../results/operon/nikuradse_2_size12 && bash prepare_ecdf.sh -0.01'   using 2:($1/50) with step lc 2 lw 2 dt "." title "Operon, 0.01",\
     '< cd ../results/operon/nikuradse_2_size12 && bash prepare_ecdf.sh -0.005'  using 2:($1/50) with step lc 3 lw 2 dt "." title "Operon, 0.005",\
     '< cd ../results/operon/nikuradse_2_size12 && bash prepare_ecdf.sh -0.027'  using 2:($1/50) with step lc 4 lw 2 dt "." title "Operon, 0.027",\
     '< cd ../results/operon/nikuradse_2_size12 && bash prepare_ecdf.sh -0.002'  using 2:($1/50) with step lc 5 lw 2 dt "." title "Operon, 0.002",\
     '< cd ../results/operon/nikuradse_2_size12 && bash prepare_ecdf.sh -0.0015' using 2:($1/50) with step lc 6 lw 2 dt "." title "Operon, 0.0015"
...
set output "../plots/with_operon/nikuradse2_mixed_len_ecdf" . extension
set multiplot layout 1,2 margins 0.1, 0.7, 0.2, 0.85 spacing 0.02,0
set ytics
set ylabel "Success probability"
set xlabel "Visited expressions"
...
plot '< cd ../results/nikuradse_2_size20 && bash prepare_ecdf.sh -0.002 12'         using 2:($1/50) with step lc 1 lw 2        title "GP (20), 0.002",\
     ...
     '< cd ../results/operon/nikuradse_2_size20 && bash prepare_ecdf.sh -0.002 12'  using 2:($1/50) with step lc 1 lw 2 dt "." title "Operon (20), 0.002",\
     '< cd ../results/operon/nikuradse_2_size20 && bash prepare_ecdf.sh -0.0015 12' using 2:($1/50) with step lc 2 lw 2 dt "." title "Operon (20), 0.0015"

unset ylabel
unset ytics
set key rmargin Left maxcols 1 samplen 2 spacing 0.8 width -7
...
plot '< cd ../results/nikuradse_2_size20 && bash prepare_ecdf.sh -0.002 100 12'         using 2:($1/50) with step lc 1 lw 2        title "GP (20), 0.002",\
     ...
     '< cd ../results/rs/nikuradse_2_size12 && bash prepare_ecdf.sh 0.002'              using 3:($1/50) with step lc 1 lw 2 dt "-" title "RS, 0.002",\
     '< cd ../results/rs/nikuradse_2_size12 && bash prepare_ecdf.sh 0.0015'             using 3:($1/50) with step lc 2 lw 2 dt "-" title "RS, 0.0015",\
     '< cd ../results/operon/nikuradse_2_size20 && bash prepare_ecdf.sh -0.002 100 12'  using 2:($1/50) with step lc 1 lw 2 dt "." title "Operon (20), 0.002",\
     '< cd ../results/operon/nikuradse_2_size20 && bash prepare_ecdf.sh -0.0015 100 12' using 2:($1/50) with step lc 2 lw 2 dt "." title "Operon (20), 0.0015"
unset multiplot

set output "../plots/with_operon/nikuradse2_mixed_len13_ecdf" . extension
set multiplot layout 1,2 margins 0.1, 0.7, 0.2, 0.85 spacing 0.02,0
set ytics
set ylabel "Success probability"
set xlabel "Visited expressions"
...
set title "Nikurase len $\\leq 13$"
plot '< cd ../results/nikuradse_2_size20 && bash prepare_ecdf.sh -0.002 13'         using 2:($1/50) with step lc 1 lw 2        title "GP (20), 0.002",\
     '< cd ../results/nikuradse_2_size20 && bash prepare_ecdf.sh -0.0015 13'        using 2:($1/50) with step lc 2 lw 2        title "GP (20), 0.0015",\
     '< cd ../results/rs/nikuradse_2_size12 && bash prepare_ecdf.sh 0.002'          using 3:($1/50) with step lc 1 lw 2 dt "-" title "RS, 0.002",\
     '< cd ../results/rs/nikuradse_2_size12 && bash prepare_ecdf.sh 0.0015'         using 3:($1/50) with step lc 2 lw 2 dt "-" title "RS, 0.0015",\
     '< cd ../results/operon/nikuradse_2_size20 && bash prepare_ecdf.sh -0.002 13'  using 2:($1/50) with step lc 1 lw 2 dt "." title "Operon (20), 0.002",\
     '< cd ../results/operon/nikuradse_2_size20 && bash prepare_ecdf.sh -0.0015 13' using 2:($1/50) with step lc 2 lw 2 dt "." title "Operon (20), 0.0015"

unset ylabel
unset ytics
set key rmargin Left maxcols 1 samplen 2 spacing 0.8 width -7
set title "Nikurase simplified len $\\leq 13$"
plot '< cd ../results/nikuradse_2_size20 && bash prepare_ecdf.sh -0.002 100 13'         using 2:($1/50) with step lc 1 lw 2        title "GP (20), 0.002",\
     '< cd ../results/nikuradse_2_size20 && bash prepare_ecdf.sh -0.0015 100 13'        using 2:($1/50) with step lc 2 lw 2        title "GP (20), 0.0015",\
     '< cd ../results/rs/nikuradse_2_size12 && bash prepare_ecdf.sh 0.002'              using 3:($1/50) with step lc 1 lw 2 dt "-" title "RS, 0.002",\
     '< cd ../results/rs/nikuradse_2_size12 && bash prepare_ecdf.sh 0.0015'             using 3:($1/50) with step lc 2 lw 2 dt "-" title "RS, 0.0015",\
     '< cd ../results/operon/nikuradse_2_size20 && bash prepare_ecdf.sh -0.002 100 13'  using 2:($1/50) with step lc 1 lw 2 dt "." title "Operon (20), 0.002",\
     '< cd ../results/operon/nikuradse_2_size20 && bash prepare_ecdf.sh -0.0015 100 13' using 2:($1/50) with step lc 2 lw 2 dt "." title "Operon (20), 0.0015"
unset multiplot


# LEN 20

set terminal cairolatex pdf input size 6cm,5cm header "\\footnotesize"
extension=".tex"
...
# GP based on mse
set output "../plots/with_operon/nikuradse2_len20_ecdf" . extension
plot '< cd ../results/nikuradse_2_size20 && bash prepare_ecdf.sh -0.01'          using 2:($1/50) with step lc 1        title "GP, 0.010",\
     '< cd ../results/nikuradse_2_size20 && bash prepare_ecdf.sh -0.005'         using 2:($1/50) with step lc 2        title "GP, 0.005",\
     '< cd ../results/nikuradse_2_size20 && bash prepare_ecdf.sh -0.003'         using 2:($1/50) with step lc 3        title "GP, 0.003",\
     '< cd ../results/nikuradse_2_size20 && bash prepare_ecdf.sh -0.0015'        using 2:($1/50) with step lc 4        title "GP, 0.0015",\
     '< cd ../results/operon/nikuradse_2_size20 && bash prepare_ecdf.sh -0.01'   using 2:($1/50) with step lc 1 dt "-" title "Operon, 0.010",\
     '< cd ../results/operon/nikuradse_2_size20 && bash prepare_ecdf.sh -0.005'  using 2:($1/50) with step lc 2 dt "-" title "Operon, 0.005",\
     '< cd ../results/operon/nikuradse_2_size20 && bash prepare_ecdf.sh -0.003'  using 2:($1/50) with step lc 3 dt "-" title "Operon, 0.003",\
     '< cd ../results/operon/nikuradse_2_size20 && bash prepare_ecdf.sh -0.0015' using 2:($1/50) with step lc 4 dt "-" title "Operon, 0.0015"
